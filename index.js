...
function addGamesToPage(games) {
    ...
    // loop over each item in the data
        ...
        gamesCard.innerHTML = `
            <img src="${game.img}" alt="${game.name}" class="game-img"></img>
...
function filterFundedOnly() {
    ...
    const fundedOnly = GAMES_JSON.filter(game => game.goal <= game.pledged);
...
const unfundedStr = 
    `A total of $${totalPledged ? game.pledged : "NaN"} has been raised for ${totalGames ? GAMES_JSON.length : "NaN"} games. 
    Currently, ${totalUnfundedGames ? game.pledged < game.goal : "NaN"} games remain unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const summaryParagraph = document.createElement('p');
summaryParagraph.innerText = unfundedStr.trim();
